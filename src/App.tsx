      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-12">
            <div>
              <h4 className="text-xl font-bold mb-4">About Meghplat</h4>
              <p className="text-gray-400">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#case-studies" className="text-gray-400 hover:text-primary">Case Studies</a></li>
                <li><a href="#careers" className="text-gray-400 hover:text-primary">Careers</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-gray-400 hover:text-primary">Whitepapers</a></li>
